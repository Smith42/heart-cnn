...
if __name__ == "__main__":
    heartCube = np.load("../logs/lossCubes/2017-08-01_15:52:00_ppt41_heartCube.npy")[...,1] # 1 is stressed, 0 is calm
    lossCube = np.load("../logs/lossCubes/2017-08-01_15:52:00_ppt41_lossCube.npy")
